...
public enum Faction {
	STARK("Stark", "Jon"), TARGARYEN("Targaryen", "Danaerys"),LANNISTER("Lannister", "Joffrey"), 
	WHITEWALKERS("White Walker", "Night King"), DOTHRAKI("Dothraki", "Khal Drogo"), WILDLINGS("Wildling", "Mance Rayder");
