...
public class Map {
	...
	private void fillCountries()
	{
		...
		countries[1] = new Country("Skagos", 10, 2.75, Continents.BLUE);
		countries[2] = new Country("Wolfswood", 3.75,7, Continents.BLUE);
		countries[3] = new Country("Winterfell", 7, 8.5, Continents.BLUE);
		countries[4] = new Country("The Rills", 2.5,10, Continents.BLUE);
		countries[5] = new Country("The Neck", 5.5,11.75, Continents.BLUE);
		countries[6] = new Country("The Flint Cliffs", 3.25,13.75, Continents.BLUE);
		...
		countries[19] = new Country("Braavosi Coastland",13.75,17,Continents.PINK);
		...
		countries[22] = new Country("Rhoyne Lands", 17.25,21.25,Continents.PINK);
