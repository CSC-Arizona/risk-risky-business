...
public class Map {
	...
	private void fillCountries() {
		...
		countries[23] = new Country("Forrest of Qohor", 19.75, 20, pink);
		countries[24] = new Country("The Golden Fields", 15.25, 25.75, pink);
		countries[25] = new Country("The Disputed Lands", 14, 29.5, pink);
		...
		countries[37] = new Country("Eastern Grass Sea", 31.5, 23.5, yellow);
		...
		countries[45] = new Country("Samyrian Hills", 34.75, 24.75, black);
